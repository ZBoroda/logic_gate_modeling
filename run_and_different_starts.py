...
def dump_data(data, filename):
    with open('andlargesizedifferentstarts/' + filename + '.pickle', 'wb') as f:
        pickle.dump(data, f)
...
if __name__ == "__main__":
    ...
    for size, ax_trajectory, ax_histogram_mutation, ax_histogram_times, ax_trajectory_random, ax_histogram_random in \
        ...
        initial_circuit = Circuit(2, zero_fit_genomes[14])
        print(size)
    ...
    fig_histogram_times.savefig('andlargesizedifferentstarts/histogram_fixations_times_and_big.png')
    plt.show()
    ...
    fig_histogram_random.savefig('andlargesizedifferentstarts/histogram_fixations_mutations_and_big_random.png')
    plt.show()
    ...
    fig.savefig('andlargesizedifferentstarts/meanmutationstillfixationAnd.png', dpi=1200)
    plt.show()

    fig, ax = plt.subplots(1, 1, tight_layout=True)
    ax.errorbar(x=sizes, y=medians_mutations)
    ax.set_title("Median Number of Mutations Until Fixation")
    fig.savefig('andlargesizedifferentstarts/medianmutationstillfixationAnd.png', dpi=1200)
    plt.show()

    fig, ax = plt.subplots(1, 1, tight_layout=True)
    ax.errorbar(x=sizes, y=means_times, yerr=np.array(stds_times) / np.sqrt(1000))
    ax.set_title("Mean Time Until Fixation")
    fig.savefig('andlargesizedifferentstarts/meantimetillfixationAnd.png', dpi=1200)
    plt.show()

    fig, ax = plt.subplots(1, 1, tight_layout=True)
    ax.errorbar(x=sizes, y=medians_times)
    ax.set_title("Median Time Until Fixation")
    fig.savefig('andlargesizedifferentstarts/mediantimetillfixationAnd.png', dpi=1200)
    plt.show()
    ...
    fig.savefig('andlargesizedifferentstarts/meanmutationstillfixationAndRandom.png', dpi=1200)
    plt.show()

    fig, ax = plt.subplots(1, 1, tight_layout=True)
    ax.errorbar(x=sizes, y=medians_mutations_random)
    ax.set_title("Median Number of Mutations Until Fixation Random Walk")
    fig.savefig('andlargesizedifferentstarts/medianmutationstillfixationAndRandom.png', dpi=1200)
    plt.show()
    ...
    fig.savefig('andlargesizedifferentstarts/meantimetillfixationAndRandom.png', dpi=1200)
    plt.show()

    fig, ax = plt.subplots(1, 1, tight_layout=True)
    ax.errorbar(x=sizes, y=means_times_random)
    ax.set_title("Median Time Until Fixation Random Walk")
    fig.savefig('andlargesizedifferentstarts/mediantimetillfixationAndRandom.png', dpi=1200)
    plt.show()
    ...
    ax.set_xscale("log")
    ax.set_title("Mean Number of Mutations Until Fixation")
    fig.savefig('andlargesizedifferentstarts/meanmutationstillfixationAndLogLog.png', dpi=1200)
    plt.show()
    ...
    ax.set_xscale("log")
    ax.set_title("Median Number of Mutations Until Fixation")
    fig.savefig('andlargesizedifferentstarts/medianmutationstillfixationAndLogLog.png', dpi=1200)
    plt.show()
    ...
    ax.set_xscale("log")
    ax.set_title("Mean Time Until Fixation")
    fig.savefig('andlargesizedifferentstarts/meantimetillfixationAndLogLog.png', dpi=1200)
    plt.show()
    ...
    ax.set_xscale("log")
    ax.set_title("Median Time Until Fixation")
    fig.savefig('andlargesizedifferentstarts/mediantimetillfixationAndLogLog.png', dpi=1200)
    plt.show()
    ...
    ax.set_xscale("log")
    ax.set_title("Mean Number of Mutations Until Fixation Random Walk")
    fig.savefig('andlargesizedifferentstarts/meanmutationstillfixationAndRandomLogLog.png', dpi=1200)
    plt.show()
    ...
    ax.set_xscale("log")
    ax.set_title("Median Number of Mutations Until Fixation Random Walk")
    fig.savefig('andlargesizedifferentstarts/medianmutationstillfixationAndRandomLogLog.png', dpi=1200)
    plt.show()
    ...
    ax.set_xscale("log")
    ax.set_title("Mean Time Until Fixation Random Walk")
    fig.savefig('andlargesizedifferentstarts/meantimetillfixationAndRandomLogLog.png', dpi=1200)
    plt.show()

    fig, ax = plt.subplots(1, 1, tight_layout=True)
    ax.loglog(sizes, means_times_random)
    ax.set_title("Median Time Until Fixation Random Walk")
    fig.savefig('andlargesizedifferentstarts/mediantimetillfixationAndRandomLogLog.png', dpi=1200)
    plt.show()